<div class="cs-best-tours">
	<h2>Senckenberg</h2>
	
	<p class="platform">Platform: Joomla</p>
	
	<p class="find-out-more find-out-more-cs">Overview</p>
	<p class="cs-overview">
	...
	<p class="find-out-more find-out-more-cs">Strategy</p>
	<p class="cs-strategy">
	...
	<p class="find-out-more find-out-more-cs">Campaigns</p>
	<ul>
		<li>Branding</li>
		<li>Link Building Campaign</li>
		<li>Dedicated Link Wheel SEO</li>
		<li>On Page Optimization</li>
		<li>Social Media Optimization</li>
	</ul>

	<p class="campaign-text-1">
	...
	<div class="container share">
	    ...
	    <div class="share-social">
	      <img src="images/share/facebook-1.png">
	      <img src="images/share/twitter-1.png">
	      <img src="images/share/pinterest-1.png">
	      <img src="images/share/gplus-1.png">
	    </div>
   </div>
</div>